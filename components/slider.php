<div id="carouselExampleCaptions" class="carousel slide  " data-bs-ride="carousel" data-bs-interval="5000">
    ...
    <div class="carousel-inner">
        <!-- <div class="container  carousel-item active">
            <div class="image">
                <img src="../images/slider-img5.png" class=" w-100 carousel-img" alt="...">
            </div>
            ...
            <div class="card  border-0 ">
                <div class="row g-0">
                    <div class="col-lg-7 col-md-4">
                        <img src="../images/slider-img10.jpg" class="img-fluid w-100 carousel-img rounded-start"
                            alt="...">
                    </div>
        ...
        <div class="  carousel-item ">
            ...
            <div class="card border-0 ">
                <div class="row g-0">
                    <div class="col-lg-7 col-md-4">
                        <img src="../images/slider-img6.png" class="img-fluid w-100 carousel-img rounded-start"
                            alt="...">
                    </div>
                    <div class="col-md-5 my-auto">
                        <div class="card-body">
        ...
        <div class="  carousel-item ">
            ...
            <div class="card border-0 ">
                <div class="row g-0">
                    <div class="col-lg-7 col-md-4">
                        <img src="../images/slider-img8.png" class="img-fluid w-100 carousel-img rounded-start"
                            alt="...">
                    </div>
                    <div class="col-md-5 my-auto">
                        <div class="card-body">
